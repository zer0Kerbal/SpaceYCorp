...
tags: SpaceYCorp,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
[![SpaceYCorp Version][MOD:shd:stat]][MOD:forum]  
[![KSP version][KSP:shd:stat]][KSP:url] [![License][LIC:shd]][LIC:url]  
![AVC .version files][AVCVAL:shd] [![Pages][MOD:pages:shd]][MOD:pages]

# Version 0.9.9.9-prerelease - `<Articles of Incorporation>` edition

* 25 Aug 2022  
* Released for Kerbal Space Program [KSP 1.12.x]

<div style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center"><h4>
<b>DO A CLEAN INSTALL:</br> DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/SpaceYCorp/files">CurseForge</a></p></div>
...
[MOD:issue]: https://github.com/zer0Kerbal/SpaceYCorp/issues/ "Issue Tracker"
[MOD:licns]: https://github.com/zer0Kerbal/SpaceYCorp/blob/master/LICENSE/ "Repo License"
[MOD:pages]: https://zer0kerbal.github.io/SpaceYCorp/ "GitHub Pages"
[MOD:pages:shd]: https://img.shields.io/badge/GitHub-Pages-white?style=plastic&labelColor=9cf&logoColor=181717&logo=github/ "GitHub IO"

<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/SpaceYCorp%20(SYC)%20-v0.9.9.9--prerelease-BADA55.svg?style=plastic&labelColor=darkgreen/ "0.9.9.9-prerelease"

[CRSFG:url]: https://www.curseforge.com/kerbal/ksp-mods/SpaceYCorp/files/ "Curseforge"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/SpaceYCorp/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?style=plastic&labelColor=black "AVC Valid"
